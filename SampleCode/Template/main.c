...
{
    /* Setup descriptor array and request callback function */
...
//    CLK_WaitClockReady(CLK_STATUS_LXTSTB_Msk);
    ...
    /* Enable USB PHY */
    /* Select the role of HS-USB to HS-USB device */
    SYS->USBPHY &= ~SYS_USBPHY_HSUSBROLE_Msk; 
    SYS->USBPHY = ((SYS->USBPHY & ~SYS_USBPHY_HSUSBACT_Msk) | SYS_USBPHY_HSUSBEN_Msk);
    CLK_SysTickDelay(20);  
